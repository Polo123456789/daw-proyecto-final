<x-app-layout>
    <div class="flex justify-center content-center">
        <div class="bg-white p-36 rounded">
            ...
            <br/>
            <p>
                Esta a punto de eliminar el registro "{{$empleado->nombre}}",
                esta es una accion que no se puede revertir. Esta seguro?
            </p>
            <div class="flex justify-center">
                <a href="/empleados" class="text-2xl m-4 border px-4 py-2 rounded text-white bg-gray-800 hover:bg-gray-900">
                    Cancelar
                </a>
                <form action="/api/empleados/eliminar" method="post">
                    @csrf
