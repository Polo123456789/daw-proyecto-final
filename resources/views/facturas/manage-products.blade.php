        ...
        <div class="flex flex-col">
            <div class="border rounded m-3 p-8">
                ...
                <div class="flex items-center m-2 flex-row gap-2">
                    ...
                    <input type="number" x-model.number="quantitySelected" class="grow bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    <button
